...
export default class MyFinance extends React.Component {
    ...
    return (
      <div>
        <Form style={{paddingTop: '1em'}}>
          <FormGroup>
            <ControlLabel>总计获得奖金:&nbsp;</ControlLabel>{'0.0 EOS'}
          </FormGroup>
          <FormGroup>
            <ControlLabel>待提取奖金:&nbsp;&nbsp;&nbsp;&nbsp;</ControlLabel>{'0.0 EOS'}
          </FormGroup>
          <Button type="submit" onClick={this.createBid.bind(this)}>提取</Button>
        </Form>
